...
const Examination = () => {
  ...
  return (
    ...
    <div className="container-fluid " style={{height:"100%",backgroundColor:"#f5f7ff", fontFamily:"Poppins, sans-serif"}}>
        ...
        <div className="col-sm-12 ">
          <div
            ...
            style={{
              ...
              minHeight: "220px",
              width:"97%",margin:" 40px auto",backgroundColor:"#f9fafb",boxShadow:"0 2px 8px rgba(0,0,0,0.1)"
            }}
          >
            <h3 className="fw-bold" style={{ color: "#38b3e4ff" }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <hr />
              <h5 className="fw-bold" style={{ color: "#38b3e4ff" }}>Question Distribution</h5>
              ...
              <div className="mb-1">
                <button type="button" className="btn btn-primary mt-3" style={{width:"50%" }} onClick={addDistributionField}>
                  + Add Subject
                </button>
              </div>
              <button type="submit" className="btn btn-primary text-white  mt-1" style={{ width:"50%"}}>
      ...
      <div className="card mx-auto mt-2 p-2" style={{width:"97%",margin:" 40px auto",backgroundColor:"#f9fafb",boxShadow:"0 2px 8px rgba(0,0,0,0.1)" }}>
        <div className="card-body">
          <div className="row">
            <div className="col-sm-12">
              <h3 className="fw-bold" style={{ color: "#38b3e4ff" }}>Examination Details</h3>
            </div>
          </div>
          <div className="row">
            <div className="col-sm-12">
                  ...
                  {exams.map((exam, index) => (
                    <tr key={exam._id}>
                     ...
                     <td>{exam.sessionId?.name || 'N/A'}</td>
                      ...
                      <td>{exam.status}</td>
                      <td>
                        <button className=" btn btn-success btn-edit me-1" onClick={() => handleEdit(exam)}>Edit</button>
                        <button className=" btn btn-danger btn-delete" onClick={() => handleDelete(exam._id)}>Delete</button>
                      </td>
                    </tr>
                  ))}
                </tbody>
